...
const variants: Record<ButtonVariant, string> = {
  unstyled: "",
  primary: "glass-interactive inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-brand px-5 text-[13px] font-semibold text-white shadow-[0_12px_28px_rgba(91,69,223,.22)] hover:-translate-y-0.5 hover:bg-brand-strong",
  secondary: "inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-[#d9d7e8] bg-white/70 px-5 text-[13px] font-semibold text-muted hover:bg-white hover:text-foreground",
